...
async function loadAllData() {
    const [byCountry, top10, byField, diasporaComp, topTalent, academicAge, overview, byCountryAll, scatterSample, qualityComparison, influenceAll] = await Promise.all([
    ...
    return { byCountry, top10, byField, diasporaComp, topTalent, academicAge, overview, byCountryAll, scatterSample, qualityComparison, influenceAll };
}
